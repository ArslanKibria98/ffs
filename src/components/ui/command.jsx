...
const CommandInput = React.forwardRef(({ className, ...props }, ref) => (
  <div className="flex items-center rounded border border-[#e4e0e9] bg-[#ececec] px-3" cmdk-input-wrapper="">
    <Search className="mr-2 h-4 w-4 shrink-0 opacity-50" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-11 w-full rounded-md bg-transparent py-3 text-sm font-light outline-none placeholder:text-[#838383] disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props} />
  </div>
