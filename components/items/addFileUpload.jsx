      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <Input
            ...
            onPressEnter={(e) => {
              setFileTypesValue([...fileTypesValue, e.target.value])
              e.target = ''
            }}
            required={true}
          />
          ...
          <Checkbox
            ...
            onChange={(e) => {
              setFilePreviewValue(e.target.checked)
            }}
          >
            Show File Preview
          </Checkbox>
          <Checkbox
            value={fileRequireValue}
            onChange={(e) => {
              setFilePreviewValue(e.target.checked)
            }}
          >
